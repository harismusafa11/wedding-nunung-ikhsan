...
export default function InvitationClient({ guestName, slug }: InvitationClientProps) {
    ...
    // Track when guest opens invitation
    useEffect(() => {
        if (isOpen && !hasTracked.current) {
            hasTracked.current = true
            fetch(`/api/guest/${slug}/track`, {
                method: 'POST'
        ...
        <div className="mobile-frame">
            ...
            {isOpen && (
                <div className="content-scroller transition-opacity duration-1000 opacity-100">
                    ...
                    <div id="rsvp"><RSVP guestName={guestName} /></div>
